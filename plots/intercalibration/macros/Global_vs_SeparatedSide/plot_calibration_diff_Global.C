void plot_calibration_diff() {
    ...
    std::string file1 = path1 + "GLOBAL_calibration_factors_Vov3.00_th12_global.txt";
    std::string file2 = path1 + "GLOBAL_calibration_factors_Vov3.00_th12_separated_side.txt";
...
std::cout << "\n[SUMMARY] Entries in calib2 = " << calib2.size() << std::endl;
    ...
    gL->SetTitle("Calibration difference;Bar index;#Delta Combined calib ");
    gL->Draw("ALP");
    gR->Draw("LP SAME");
