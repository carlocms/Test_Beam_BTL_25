      ...
      for(int iBar = 0; iBar < 16; ++iBar)
        {
	      ...
	      fitFunc_deltaT_Raw_R[index2] = DrawAndFitHistogram(
	       ...
	       offsets_deltaT_raw[std::pair(index2,"R")] = fitFunc_deltaT_Raw_R[index2]->GetParameter(1);
              ...
              mean_fitFunc_deltaT_Raw[std::make_tuple(iBar,Vov,vth1,"R")] = std::make_pair(fitFunc_deltaT_Raw_R[index2]->GetParameter(1), fitFunc_deltaT_Raw_R[index2]->GetParameter(2));
              }
...
PlotGraphs(g_MeanfitFunc_deltaT_Raw_L,g_MeanfitFunc_deltaT_Raw_R,"Mean_DeltaT_Raw_TGraphError","#mu_{#DeltaT} [ps] ",plotDir + "Loop3/MeanfitFunc_deltaT_Raw", 0., 3000.);
...
DrawOverlayFitsFromIndices(
		...
		{13001204,13001205,13001206,13001207,13001208,13001209,13001210},
		"c_overlay_L_selected"
		,plotDir+"/Loop4/TW_EneDUT/TW_func_comparison/Side_L","Side L comparison");

DrawOverlayFitsFromIndices(
		fitFunc_deltaT_EneRCorr_R,
		{13001204,13001205,13001206,13001207,13001208,13001209,13001210},
		"c_overlay_R_selected"
		,plotDir+"Loop4/TW_EneDUT/TW_func_comparison/Side_R","Side R comparison");
